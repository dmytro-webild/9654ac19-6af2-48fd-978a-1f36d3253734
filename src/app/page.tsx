...
export default function LandingPage() {
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        {
          type: "text",
          content: "Restoring Cleanliness to Your Bins",
        },
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/garbage-man-making-silence-gesture_1368-1523.jpg",
          alt: "friendly service professional washing",
        },
      ]}
    />
  </div>
  ...
  <div id="benefits" data-section="benefits">
      ...
      features={[
        {
          title: "Eco-Friendly",
          description: "100% biodegradable agents.",
          media: {
            imageSrc: "http://img.b2bpic.net/free-photo/gardening-home-with-plant_23-2149007981.jpg",
        ...
        },
        {
          ...
          items: [
            ...
            {
              icon: CheckCircle,
              text: "Hard grime removal",
            },
          ],
          reverse: true,
          imageSrc: "http://img.b2bpic.net/free-photo/garbage-man-making-silence-gesture_1368-1523.jpg",
          imageAlt: "eco friendly cleaning supplies",
        },
        {
          title: "Odor Control",
          description: "Lasting fresh results.",
          media: {
            imageSrc: "http://img.b2bpic.net/free-photo/front-view-spray-young-man-white-t-shirt-using-spray-against-covid-blue-floor_140725-11138.jpg",
            imageAlt: "deodorized clean trash container",
          },
          items: [
            {
              icon: CheckCircle,
              text: "Smell elimination",
            },
            {
              icon: CheckCircle,
              text: "Fresh scent finish",
            },
          ],
          reverse: false,
  ...
  <div id="services" data-section="services">
      ...
      products={[
        ...
        },
        {
          ...
          price: "$79",
          imageSrc: "http://img.b2bpic.net/free-photo/truck-driver-putting-gloves-remove-vehicle-tarpaulin-unloading_342744-1295.jpg",
        },
        {
          id: "p4",
        ...
        {
          id: "p5",
          name: "Annual Total Care",
          price: "$350",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-man-cleaning-staircase-handrail-gloves_176474-2816.jpg",
        },
        {
          id: "p6",
          name: "Move-In Special",
          price: "$55",
          imageSrc: "http://img.b2bpic.net/free-photo/plastic-trash-can-white-background_1387-149.jpg",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          company: "Local Resident",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-young-woman-big-city-woman-city_169016-66523.jpg",
        },
        {
          id: "5",
          name: "Laura Scott",
      ...
      faqs={[
        {
          ...
          content: "We recommend at least quarterly for optimal freshness.",
        },
        {
          id: "f2",
          title: "Do I need to be home?",
          content: "No, we work independently on your scheduled day.",
        },
        {
          id: "f3",
          title: "Is the water safe?",
          content: "Yes, we use filtered greywater friendly solutions.",
        },
        {
          id: "f4",
          title: "What areas do you serve?",
          content: "We provide service within a 20-mile radius of the city center.",
        },
        {
          id: "f5",
          title: "How can I pay?",
          content: "We accept all major credit cards and digital payments online.",
        },
      ]}
